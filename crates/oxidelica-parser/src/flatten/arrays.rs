...
use super::builtins::{folded_over_an_array, shaped_by_a_builtin};
use super::shapes::*;
use super::*;
...
pub(super) fn as_block(value: Value) -> Result<Vec<Vec<Expr>>, String> {
    Ok(match value {
...
pub(super) fn settled_by(expr: &Expr, shapes: &Shapes) -> Option<f64> {
    if shapes.loop_vars.is_empty() {
