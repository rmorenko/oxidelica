...
— кросс-сборкой всего workspace, включая GUI, в настоящие `.exe`. Запуск
самих виндовых бинарников и их тестов — задача CI на windows-раннере: с
макбука это без Wine не сделать.
...
`mingw-w64`. Обе проверки запускаются с макбука, не выходя из
репозитория:
